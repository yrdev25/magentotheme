...
class Interceptor extends \Magento\UrlRewriteGraphQl\Model\Resolver\EntityUrl implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\UrlRewrite\Model\UrlFinderInterface $urlFinder, \Magento\UrlRewriteGraphQl\Model\Resolver\UrlRewrite\CustomUrlLocatorInterface $customUrlLocator)
    {
        $this->___init();
        parent::__construct($urlFinder, $customUrlLocator);
    }
