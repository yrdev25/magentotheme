...
class Interceptor extends \Magento\QuoteGraphQl\Model\Cart\SetPaymentMethodOnCart implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Quote\Api\PaymentMethodManagementInterface $paymentMethodManagement, \Magento\Quote\Api\Data\PaymentInterfaceFactory $paymentFactory, \Magento\QuoteGraphQl\Model\Cart\Payment\AdditionalDataProviderPool $additionalDataProviderPool, ?\Magento\Checkout\Api\PaymentProcessingRateLimiterInterface $paymentRateLimiter = null)
    {
        $this->___init();
        parent::__construct($paymentMethodManagement, $paymentFactory, $additionalDataProviderPool, $paymentRateLimiter);
    }
