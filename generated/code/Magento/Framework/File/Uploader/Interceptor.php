...
class Interceptor extends \Magento\Framework\File\Uploader implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct($fileId, ?\Magento\Framework\File\Mime $fileMime = null, ?\Magento\Framework\App\Filesystem\DirectoryList $directoryList = null, ?\Magento\Framework\Filesystem\DriverPool $driverPool = null)
    {
        $this->___init();
        parent::__construct($fileId, $fileMime, $directoryList, $driverPool);
    }
